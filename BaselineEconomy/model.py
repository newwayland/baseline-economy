...
class BaselineEconomyAgent(Agent):  # noqa
    """
    An agent
    """
    ...
    def step(self):
        """
        Modify this method to change what an individual agent will do
        during each step.  Can include logic based on neighbors states.
        """
        pass
...
class BaselineEconomyModel(Model):
    ...
    def __init__(self, num_agents, width, height):
        ...
        for i in range(self.num_agents):
            agent = BaselineEconomyAgent(i, self)
